...
def _validate_safe_area(spec: LabelSpec, report: Report) -> None:
    """Reject visible non-background content that intrudes into the configured safe area."""
...
def _content_bounds(image: Any) -> tuple[int, int, int, int] | None:
    """Find visible content bounds, treating a uniform corner background as full bleed."""
