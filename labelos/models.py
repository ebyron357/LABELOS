...
class LabelSpec:
    ...
    def to_dict(self, artwork_name: str | None = None) -> dict[str, Any]:
        """Return the JSON-compatible specification stored in a release package."""
        return {
            "artwork": artwork_name or self.artwork.name,
