...
| `SVG_LINKED_IMAGE_INSPECTION_FAILED` | SVG image reference is remote, unsafe, missing, symlinked, or unreadable | Use a readable raster stored beneath the SVG without symlinks; package it with the SVG |
