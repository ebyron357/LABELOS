...
| `SVG_LINKED_IMAGE_INSPECTION_FAILED` | SVG linked a missing, remote, symlinked, or out-of-directory raster | Use a readable regular file at a relative path below the SVG directory |
