...
| `SVG_LINKED_IMAGE_INSPECTION_FAILED` | SVG linked image is remote, unsafe, missing, symlinked, or unreadable | Use a regular local file below the SVG directory, without query strings or fragments |
