...
- `labelos verify-package DESTINATION`: verifies all package checksums and byte counts,
  rejects path-traversal or symlinked manifest entries, and checks that the passing report,
  manifest, spec, and artwork agree.
