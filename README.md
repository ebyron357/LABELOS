...
- `labelos verify-package DESTINATION`: verifies checksums and rejects malformed manifests,
  unsupported manifest schemas, unsafe artifact paths, and packages without a passing
  validation result.
