...
code was checked. When `safe_area_mm` is nonzero, visible marks must remain within the trim
area inset by the configured bleed plus safe-area margin; a uniform full-bleed canvas background
is allowed.
