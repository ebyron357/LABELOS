...
- `labelos verify-package DESTINATION`: fails closed when a package manifest is malformed,
  references an unsafe/non-regular file, has a mismatched hash or byte count, or contains a
  non-passing/inconsistent validation report.
