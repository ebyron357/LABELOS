...
| `SVG_LINKED_IMAGE_DPI_TOO_LOW` | A local raster linked by an SVG is below `min_dpi` |
| `SVG_LINKED_IMAGE_INSPECTION_FAILED` | An SVG-linked image is missing, unsafe, unreadable, or not local |
