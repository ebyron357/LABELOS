...
- `labelos verify-package DESTINATION`: verifies the manifest schema, checksums and byte
  counts, validation-report/spec consistency, regular files, and that no
  unreviewed files are present. It rejects symlinks and manifest path traversal.
