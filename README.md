...
- `labelos verify-package DESTINATION`: verifies the release schema, permitted file set,
  regular-file paths, byte sizes, SHA-256 checksums, and agreement between the passing report
  and manifest specification.
