...
- `labelos verify-package DESTINATION`: verifies checksums, byte counts, expected package
  contents, the artwork-to-spec binding, and that the recorded validation passed.
