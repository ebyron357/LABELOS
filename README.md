...
- `labelos verify-package DESTINATION`: verifies the schema, safe package-local filenames,
  byte counts, checksums, passing validation report, and that the packaged spec refers to the
  packaged artwork.
