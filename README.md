...
- `labelos verify-package DESTINATION`: verifies manifest schema, safe package-local filenames,
  checksums, byte counts, the passing validation report, and that the embedded specification
  references the packaged artwork.
