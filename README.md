...
- `labelos verify-package DESTINATION`: verifies manifest schema, package-local filenames,
  checksums, byte counts, the passing validation report, and the embedded label specification.
