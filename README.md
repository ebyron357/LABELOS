...
- `labelos verify-package DESTINATION`: verifies checksums, byte counts, regular-file-only
  payloads, canonical package-local specification, and a passing validation report.
