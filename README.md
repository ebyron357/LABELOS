...
code was checked. When `safe_area_mm` is nonzero, LABELOS raster-inspects the artwork and
rejects visible content outside the bleed plus safe-area inset. A uniform full-bleed canvas
background is ignored; artwork whose corners cannot establish that background fails closed.
