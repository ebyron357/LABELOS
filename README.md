...
- `labelos verify-package DESTINATION`: verifies package checksums and byte counts,
  rejects traversal and symlinked artifacts, and confirms the specification and report
  describe a passing release.
