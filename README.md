...
10. **Release** only the verified package directory. Keep the artwork, any validated linked
    SVG raster assets, `validation-report.json`, `label-spec.json`, and `manifest.json`
    together. Do not edit files after packaging.
...
| `SVG_LINKED_IMAGE_INSPECTION_FAILED` | Linked SVG image is missing, unsafe, or unreadable |
