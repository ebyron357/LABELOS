...
When `safe_area_mm` is non-zero, LABELOS also rejects visible PNG pixels, SVG text/images/rects,
and PDF text/images/vector drawings that extend beyond the trim inset. Unsupported SVG
