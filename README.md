...
code was checked. When `safe_area_mm` is nonzero, visible artwork must remain inside the
`bleed_mm + safe_area_mm` inset; a uniform full-bleed canvas background is excluded from this
content-bound check.
