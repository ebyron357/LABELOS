...
- `labelos verify-package DESTINATION`: verifies release-package schema, safe file paths,
  regular files, byte counts, SHA-256 checksums, passing validation-report state, specification
  consistency, and that no unexpected files were added.
