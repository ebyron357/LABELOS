...
- `labelos verify-package DESTINATION`: verifies the manifest schema and checksums/byte counts
  for every package payload. Manifest entries must name package-local files; traversal paths are
  rejected.
