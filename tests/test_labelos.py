...
def test_png_safe_area_allows_uniform_full_bleed_background(tmp_path):
    artwork = tmp_path / "full-bleed-background.png"
    image = Image.new("RGB", (106, 56), "#0b3d91")
...
def test_png_safe_area_rejects_nonuniform_full_bleed_content(tmp_path):
    artwork = tmp_path / "full-bleed-content.png"
