...
Verified on 2026-08-14 from implementation commit `d445402`:
...
sdist and wheel were created in `/tmp/labelos-production-build`; and the end-to-end release package was
