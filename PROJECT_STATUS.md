...
| Linked (non-embedded) SVG raster files | **AVAILABLE NOW** (only local, regular non-symlink files beneath the SVG directory are accepted, DPI-checked, checksummed, and packaged) |
