...
python3 -m labelos package examples/label.json /tmp/labelos-e2e-release-1789377110
python3 -m labelos verify-package /tmp/labelos-e2e-release-1789377110 # PASS
