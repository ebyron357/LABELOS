...
- Immutable-style release directories containing copied artwork, validation report, manifest,
  canonical label specification, and SHA-256 checksums.
- Package verification checks the manifest schema, safe package-local filenames, SHA-256 values,
  byte counts, a passing validation report, and agreement among artwork, report, and spec.
