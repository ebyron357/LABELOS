...
- Immutable-style release directories containing copied artwork, a canonical package-local
  label spec, validation report, manifest, SHA-256 checksums, and byte counts.
- Package verification rejects malformed schemas, non-local paths, symlinks, unexpected files,
  failed reports, and disagreement among the package spec, manifest, and validation report.
...
Verified on 2026-08-10 from commit `6ecf4806f5ffe4084403449ac613fa84ec51cba9`:
...
generated in `dist/`; and the end-to-end package was created and checksum, byte-count,
schema, report, and spec verified at `/tmp/labelos-e2e`.
`doctor` confirmed PyMuPDF and ZXing-C++ are available; Callas pdfToolbox remains unavailable.
QR and Code 128 regression tests generate raster, SVG, and PDF fixtures and verify their
decoded expected values. Package regression tests cover artwork tampering, passing-report
enforcement, and unsafe manifest filenames. GitHub Actions runs tests, lint, and builds on
