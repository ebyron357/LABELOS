...
- Passing and failing fixture coverage plus CLI/package regression tests, including safe-area
  acceptance and PNG/SVG/PDF violation cases.
...
Verified on 2026-08-14 from commit `f32e9f724a27e810377eddf27f7b1e03688630ad`:
...
generated in `/tmp/labelos-build`; and the end-to-end package was created and
checksum-verified at `/tmp/labelos-e2e`.
`doctor` confirmed PyMuPDF and ZXing-C++ are available; Callas pdfToolbox remains unavailable.
QR and Code 128 regression tests generate raster, SVG, and PDF fixtures and verify their
decoded expected values. Safe-area checks ignore a uniform full-bleed canvas background and
fail closed if that background cannot be determined. GitHub Actions runs tests, lint, and
