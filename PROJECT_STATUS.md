...
Verified on 2026-08-15 from code commit `9729d0e62274711cd7a2ef0e606d5fa4e75481b6`:
...
the sdist and wheel were generated in `/tmp/labelos-production-build`; and a schema-v2
end-to-end package was created and checksum-verified at `/tmp/labelos-final-e2e`.
