...
- Schema-v2 manifests are verified fail-closed: legacy/malformed manifests, unsafe paths,
  symlinks, non-regular or unexpected files, byte-count/checksum mismatches, and inconsistent
  validation reports are rejected.
...
Verified on 2026-08-16 from the working tree based on
`1e86abdfb7e876f540dc209dfd102d7c7a7056b3`:
...
python3 -m labelos.cli package examples/label.json /tmp/labelos-release-final-lz37aX/release --json
python3 -m labelos.cli verify-package /tmp/labelos-release-final-lz37aX/release --json
python3 -m labelos.cli doctor --json
```

Results: 13 tests passed; Ruff, compilation, and dependency checks passed; the isolated sdist
and wheel were generated in `/tmp/labelos-build-final`; and the end-to-end package was created
and schema-v2 checksum-verified at `/tmp/labelos-release-final-lz37aX/release`.
