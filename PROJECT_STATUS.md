...
- Immutable-style release directories containing copied artwork, validation report, manifest,
  and SHA-256 checksums. Package verification rejects malformed or unsupported manifests,
  unsafe artifact paths, malformed checksums, and manifests that do not attest to passing
  validation.
...
Verified on 2026-08-14 from commit `aed88b58be8a5d2ea4b25f987a27438ca8a91c2d`:
...
Results: 11 tests passed; Ruff, bytecode compilation, and dependency checks passed; the sdist
and wheel were generated in `/tmp/labelos-production-build`; and the end-to-end package was
created and checksum-verified at `/tmp/labelos-production-e2e`. `doctor` confirmed PyMuPDF and
