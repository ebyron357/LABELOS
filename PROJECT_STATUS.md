...
Verified on 2026-08-16 from working tree based on commit `1e86abd08646dfef720fc2f45fa168846527aec5`:
...
python3 -m build --outdir /tmp/labelos-e2e-tFJYdy/build
python3 -m labelos.cli validate examples/label.json --json
python3 -m labelos.cli package examples/label.json /tmp/labelos-e2e-tFJYdy/release --json
python3 -m labelos.cli verify-package /tmp/labelos-e2e-tFJYdy/release --json
python3 -m labelos.cli doctor --json
```

Results: 13 tests passed; Ruff, compileall, and dependency checks passed; the sdist and wheel
were generated at `/tmp/labelos-e2e-tFJYdy/build`; and the end-to-end package was created and
schema/integrity-verified at `/tmp/labelos-e2e-tFJYdy/release`.
