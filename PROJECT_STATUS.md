...
| Linked (non-embedded) SVG raster files | **AVAILABLE NOW** (safe relative regular files beneath the artwork directory are decoded, DPI-checked, checksummed, and included in release packages; remote, absolute, traversal, missing, and symlinked paths fail closed) |
...
Verified on 2026-08-19 from the production-readiness branch, based on `main` at `19167e0`:
