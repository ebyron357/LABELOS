...
- Safe-area validation for PNG, SVG, and PDF artwork. The validator ignores a uniform
  full-bleed background and fails closed if visible content bounds cannot be determined.
...
`e8fdd712792a31783ac04873cf06128b40a5b670`:
...
and wheel were generated in `/tmp/labelos-final-build`; and the end-to-end package was created
and checksum-verified at `/tmp/labelos-final-e2e`.
`doctor` confirmed PyMuPDF and ZXing-C++ are available; Callas pdfToolbox remains unavailable.
QR and Code 128 regression tests generate raster, SVG, and PDF fixtures and verify their
decoded expected values. Safe-area regressions cover uniform full-bleed backgrounds and
out-of-bounds raster and SVG content. GitHub Actions runs tests, lint, and builds on Python
3.10 and 3.12.
