...
| Linked (non-embedded) SVG raster files | **AVAILABLE NOW** (plain local relative rasters are decoded, DPI-checked, checksummed, and packaged; URLs, traversal, and symlinks fail closed) |
...
Verified on 2026-09-06 from commit `a4c4457` (`cursor/label-production-system-readiness-87e8`):
