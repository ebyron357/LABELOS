...
Run the full verification record above after merging the linked-SVG-raster change. No
other implementation gaps are currently identified; remaining items are the documented
