...
Verified on 2026-09-06 from the current production-readiness branch at `e331db4`:
...
python3 -m labelos package examples/label.json /tmp/labelos-e2e-release
python3 -m labelos verify-package /tmp/labelos-e2e-release     # PASS
