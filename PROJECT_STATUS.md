...
Verified on 2026-08-18 from commit `513f5ffb449e707afdf935956c21944dcc7459fb`:
...
python3 -m labelos.cli package examples/label.json /tmp/labelos-package-20260818 --json
python3 -m labelos.cli verify-package /tmp/labelos-package-20260818 --json
python3 -m labelos.cli doctor --json
```

Results: 10 tests passed; Ruff, bytecode compilation, and installed-dependency consistency
checks passed; the sdist and wheel were generated in `dist/`; and the end-to-end package was
created and checksum-verified at `/tmp/labelos-package-20260818`. A direct malformed-PDF CLI
check returned structured `PDF_INVALID` JSON and exit code 1, without a traceback.
