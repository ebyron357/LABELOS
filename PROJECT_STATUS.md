...
Verified on 2026-08-18 from commit `c03f420`:
...
checksum-verified at `/tmp/labelos-e2e-20260818`. A malformed PDF CLI regression exits with
status 1 and emits a structured `PDF_INVALID` report without a traceback.
