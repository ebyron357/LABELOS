...
| Linked (non-embedded) SVG raster files | **AVAILABLE NOW** (safe relative local rasters are decoded, DPI-checked, packaged, and checksummed; remote, absolute, traversal, missing, and symlink sources fail closed) |
...
Verified on 2026-08-19 at commit `97c1ed1a61af77f9c71cf3deb91673f9768dbc7b`:
